            ...
            <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {workshops.map((workshop) => (
                        <div key={workshop.id} className="border border-gray-200 rounded-lg p-5 hover:shadow-md transition-shadow">
                            <div className="flex items-start justify-between mb-3">
                                <div className="flex items-center space-x-3">
                                    <div className="p-2 bg-[#00565c]/10 rounded-lg">
                                        <BookOpen className="w-5 h-5 text-[#00565c]" />
                                    </div>
                                    <div>
                                        <h3 className="font-semibold text-gray-800">{workshop.title}</h3>
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-4 text-sm">
                                <div>
                                    ...
                                    <p className="font-medium text-gray-800">{workshop.date}</p>
                                </div>
                                <div>
                                    <p className="text-gray-500">Duration</p>
                                    <p className="font-medium text-gray-800">{workshop.duration}</p>
                                </div>
                                <div>
                                    <p className="text-gray-500">Capacity</p>
                                    <p className="font-medium text-gray-800">{workshop.enrolled}/{workshop.capacity}</p>
                                </div>
                                <div>
                                    <p className="text-gray-500">Status</p>
                                    <p className={`font-medium ${workshop.enrolled === workshop.capacity ? 'text-red-500' : 'text-green-500'
                                        }`}>
